...
-- === IF AGENT EXISTS ===
ALTER AGENT AM_SKI_RESORT_DEV.AGENTS.SKI_OPS_ASSISTANT
...
ALTER AGENT AM_SKI_RESORT_DEV.AGENTS.SKI_OPS_ASSISTANT SET
  COMMENT = 'Operations analytics agent for lift supervisors and operations managers. Covers lift wait times, staffing coverage, weather conditions, and safety incidents across 18 lifts and 8 mountain zones.',
  PROFILE = '{"display_name": "Ski Operations Assistant", "color": "blue"}';

-- === IF AGENT DOES NOT EXIST ===
CREATE AGENT IF NOT EXISTS AM_SKI_RESORT_DEV.AGENTS.SKI_OPS_ASSISTANT
COMMENT = 'Operations analytics agent for lift supervisors and operations managers. Covers lift wait times, staffing coverage, weather conditions, and safety incidents across 18 lifts and 8 mountain zones.'
PROFILE = '{"display_name": "Ski Operations Assistant", "color": "blue"}'
FROM SPECIFICATION
$$
