-- Strategy: ALTER if agent exists, CREATE if new
-- === IF AGENT EXISTS ===
ALTER AGENT AM_SKI_RESORT_DEV.AGENTS.RESORT_EXECUTIVE
...
$$
{
  ...
  "tool_resources": {
    "DailySummaryKPIs": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_DAILY_SUMMARY",
    ...
    "RevenueAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_REVENUE",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "CustomerAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_CUSTOMER_BEHAVIOR",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "LiftOperations": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_OPERATIONS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "StaffingAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_STAFFING_ANALYTICS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "WeatherAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_WEATHER_ANALYTICS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "MarketingAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_MARKETING_ANALYTICS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "CustomerSatisfaction": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_CUSTOMER_SATISFACTION",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "SafetyIncidents": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_SAFETY_INCIDENTS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "SkiSchoolAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_LESSONS_ANALYTICS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
    ...
    "PassholderAnalytics": {
      "semantic_view": "AM_SKI_RESORT_DEV.SEMANTIC.SEM_PASSHOLDER_ANALYTICS",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "AM_SKI_RESORT_WH_DEV",
        "query_timeout": 299
...
ALTER AGENT AM_SKI_RESORT_DEV.AGENTS.RESORT_EXECUTIVE SET
  COMMENT = 'Comprehensive business intelligence agent for resort executives. Unified view across operations, customers, revenue, marketing, staffing, weather, satisfaction, safety, ski school, and pass programs. ',
  PROFILE = '{"display_name": "Resort Executive Assistant", "color": "purple"}';

-- === IF AGENT DOES NOT EXIST ===
CREATE AGENT IF NOT EXISTS AM_SKI_RESORT_DEV.AGENTS.RESORT_EXECUTIVE
COMMENT = 'Comprehensive business intelligence agent for resort executives. Unified view across operations, customers, revenue, marketing, staffing, weather, satisfaction, safety, ski school, and pass programs. '
PROFILE = '{"display_name": "Resort Executive Assistant", "color": "purple"}'
FROM SPECIFICATION
$$
