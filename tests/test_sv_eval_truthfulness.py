...
from agent_management.evals.sv_comment import (
    _classify_header,
    _coalesce_threshold,
    _derive_all_passed,
    render_markdown,
)
from agent_management.evals.sv_scores import run_name_candidates, score_results
...
def test_extract_platform_error_code_returns_signature():
    from agent_management.evals.sv_scores import extract_platform_error_code
...
def test_regen_strip_request_id_comment():
    from agent_management.semantic_views.regen_gold import strip_request_id_comment
...
def test_regen_column_sorted_rows_handles_mixed_types_and_nones():
    from agent_management.semantic_views.regen_gold import _column_sorted_rows
